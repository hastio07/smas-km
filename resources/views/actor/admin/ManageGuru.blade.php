    ...
    <div class="content-wrapper rounded p-3 shadow">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button class="btn border-primary shadow text-primary mb-2" data-bs-target="#exampleModal" data-bs-toggle="modal" type="button">
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="rounded p-3 shadow h-100 mt-2">
                            ...
                            <div class="mb-2 mt-4">
                                <ol class="list-unstyled">
                                    <li class="border-bottom p-0">waka Kurikulum<button class="btn"><i class="bi bi-trash3 text-danger"></i></button></li>
                                    <li class="border-bottom p-0">weka Kemahasiswaan <button class="btn"><i class="bi bi-trash3 text-danger"></i></button></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="rounded p-3 shadow h-100 mt-2">
                            ...
                            <div class="mb-2 mt-4">
                                <ol class="list-unstyled">
                                    <li class="border-bottom p-0">PNS <button class="btn"><i class="bi bi-trash3 text-danger"></i></button></li>
                                    <li class="border-bottom p-0">P3K <button class="btn"><i class="bi bi-trash3 text-danger"></i></button></li>
                                    <li class="border-bottom p-0">Honorer <button class="btn"><i class="bi bi-trash3 text-danger"></i></button></li>
                                </ol>
                            </div>
                        </div>
                    </div>
